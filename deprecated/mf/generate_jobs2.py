...
def main():
    ...
    funcs = [data_dir, nonlinear, batch_size, size, hidden_size, dropout, learning_rate, loss, ckpt, n_sampled, n_resample]
    
    paras = [   
                ["$data_part", "relu", 64, 32, 1000, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 1000, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 1000, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 1000, 0.5, 0.3, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 500, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 500, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 500, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 32, 500, 0.5, 0.3, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 64, 500, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 64, 500, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 64, 500, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 64, 500, 0.5, 0.3, "warp", 4000, 1024, 100,],

                ["$data_part", "relu", 64, 128, 500, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 128, 500, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 128, 500, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 128, 500, 0.5, 0.3, "warp", 4000, 1024, 100,],
                ["$data_part", "relu", 64, 128, 500, 0.5, 0.1, "warp", 4000, 1024, 100,],

                ["$data_part", "tanh", 64, 128, 500, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", "tanh", 64, 128, 500, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", "tanh", 64, 128, 500, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", "tanh", 64, 128, 500, 0.5, 0.3, "warp", 4000, 1024, 100,],
                ["$data_part", "tanh", 64, 128, 500, 0.5, 0.1, "warp", 4000, 1024, 100,],
             ]
