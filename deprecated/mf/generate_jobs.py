...
def main():
    ...
    paras = [["$data_part", 64, 32, 0.5, 1, "ce", 4000, 1024, 100,],
                ...
                ["$data_part", 64, 32, 0.5, 2, "ce", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 5, "ce", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 10, "ce", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 20, "ce", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 1, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 2, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 3, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 5, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 10, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 15, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 20, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 0.5, "warp", 4000, 1024, 100,],
                ["$data_part", 64, 32, 0.5, 0.5, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 1, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 3, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 5, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 8, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 10, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 15, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 20, "mw", 4000, 5000, 100,],
                ["$data_part", 64, 32, 0.5, 30, "mw", 4000, 5000, 100,],
             ]
