...
from load_ml100k_data import load_movie, load_user

class Evaluate(object):
    def __init__(self, logit_ind2item_ind, res_filename='../submissions/ml100k_res_T.csv', 
        hist_filename = '../submissions/ml100k_historical_train.csv', ta=1, old=False, data_dir=None):
...
def print_scores(name_):
    r = load_submit(name_)
    T = load_submit('../submissions/ml100k_res_T.csv')
